        ...
        var c, d = b.documentElement,
            ...
            s = function() {
                var i, q, s, u, v, w, x, y, z, A, B, C, D, E = /^img$/i,
                    ...
                    L = 0,
                    M = function(a) {
                        K--, a && a.target && m(a.target, M), (!a || 0 > K || !a.target) && (K = 0)
                    },
                    N = function(a, b) {
                        var c, d = a,
                    ...
                    O = function() {
                        var a, b, d, e, f, g, h, j, k, l;
                        if ((v = c.loadMode) && 8 > K && (a = i.length)) {
                            for (d = Date.now(), b = L, J++, D > I && 1 > K && J > 4 && v > 2 ? (I = D, J = 0) : I = I != C && v > 1 && J > 3 ? C : H; a > b; b++, L++)
                                if (i[b] && !i[b]._lazyRace)
                                    if (G)
                                        if ((k = i[b].getAttribute("data-expand")) && (h = 1 * k) || (h = I), l !== h && (w = innerWidth + h, x = innerHeight + h, j = -1 * h, l = h), e = i[b].getBoundingClientRect(), (B = e.bottom) >= j && (y = e.top) <= x && (A = e.right) >= j && (z = e.left) <= w && (B || A || z || y) && (s && 3 > K && 4 > J && !k && v > 2 || N(i[b], h))) S(i[b], !1, e.width), L--, d++, g = !0;
                                        else {
                                            if (J && Date.now() - d > 3) return L++, void P();
                    ...
                    P = r(O),
                    Q = function(a) {
                        k(a.target, c.loadedClass), l(a.target, c.loadingClass), m(a.target, Q)
                    },
                    R = function(a, b) {
                        try {
                    ...
                    S = function(a, b, d) {
                        var e, i, p, q, r, v, w, x, y, z, A, B = a.currentSrc || a.src,
                            C = E.test(a.nodeName),
                        ...
                        (!G && s || !C || !B || a.complete || j(a, c.errorClass)) && (a._lazyRace = !0, g(function() {
                            if (a._lazyRace && delete a._lazyRace, l(a, c.lazyClass), !(y = n(a, "lazybeforeunveil", {
                                ...
                                if (D && (G ? (t.updateElem(a, !0, d), k(a, c.autosizesClass)) : a.setAttribute("sizes", D)), v = a.getAttribute(c.srcsetAttr), r = a.getAttribute(c.srcAttr), C && (w = a.parentNode, x = h.test(w.nodeName || "")), z = y.detail.firesLoad || "src" in a && (v || r || x), z && (K++, m(a, M, !0), clearTimeout(u), u = f(M, 2500), k(a, c.loadingClass), m(a, Q, !0)), x)
                                    for (e = w.getElementsByTagName("source"), i = 0, p = e.length; p > i; i++)(A = c.customMedia[e[i].getAttribute("data-media") || e[i].getAttribute("media")]) && e[i].setAttribute("media", A), q = e[i].getAttribute(c.srcsetAttr), q && e[i].setAttribute("srcset", q);
                                v ? a.setAttribute("srcset", v) : r && (F.test(a.nodeName) ? R(a, r) : a.setAttribute("src", r)), (v || x) && o(a, {
                                    src: r
                                })
                            }(!z || a.complete && B == (a.currentSrc || a.src)) && (z && M(y), Q(y)), a = null
                        }))
                    },
                    T = function() {
                        var a, b = function() {
                        ...
                        s = !0, J += 8, c.loadMode = 3, e("scroll", function() {
                            3 == c.loadMode && (c.loadMode = 2), clearTimeout(a), a = f(b, 99)
                        }, !0)
                    };
                return {
                    _: function() {
                        i = b.getElementsByClassName(c.lazyClass), q = b.getElementsByClassName(c.lazyClass + " " + c.preloadClass), C = c.expand, D = Math.round(C * c.expFactor), e("scroll", P, !0), e("resize", P, !0), a.MutationObserver ? new MutationObserver(P).observe(d, {
                            childList: !0,
                            subtree: !0,
                            attributes: !0
                        }) : (d.addEventListener("DOMNodeInserted", P, !0), d.addEventListener("DOMAttrModified", P, !0), setInterval(P, 999)), e("hashchange", P, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend", "webkitAnimationEnd"].forEach(function(a) {
                            b.addEventListener(a, P, !0)
                        }), (s = /d$|^c/.test(b.readyState)) ? T() : (e("load", T), b.addEventListener("DOMContentLoaded", P)), P()
                    },
                    checkElems: P,
                    unveil: S
                }
